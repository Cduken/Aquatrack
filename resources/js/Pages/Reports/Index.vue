<template>
    <div class="relative w-full min-h-screen overflow-hidden">
        ...
        <div class="fixed inset-0 bg-gradient-to-br from-[#062F64]/80 to-[#1E4272]/80">
        ...
        <div class="fixed top-1/4 left-1/4 w-64 h-64 rounded-full bg-blue-500 opacity-10 blur-3xl"></div>
        <div class="fixed bottom-1/3 right-1/4 w-96 h-96 rounded-full bg-teal-500 opacity-10 blur-3xl"></div>

        <!-- Main content -->
        <div class="relative z-10 flex items-center justify-center min-h-screen w-full">
            <div class="flex items-center justify-center flex-col p-4 md:p-8 w-full max-w-3xl">
                <div class="flex items-center justify-center flex-col mb-6">
                    <v-icon name="bi-exclamation-triangle-fill" class="mb-3 text-[#F87171]" scale="3.5" />
                    <h1 class="text-2xl md:text-3xl text-white font-bold">Report Water Issue</h1>
                    <p class="text-gray-300 mt-1 text-center text-sm">Report water emergencies, leaks, or other issues in
                        your area</p>
                </div>
                ...
                <p class="mt-3 text-xs text-gray-300">For immediate emergencies, please call 911 or your local
