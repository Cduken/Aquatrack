        ...
        <div class="w-full bg-white shadow-md rounded-lg overflow-hidden">
            <div class="p-4 md:p-6">
                ...
                <div class="mt-6 overflow-x-auto">
                    <!-- Desktop Table -->
                    <table
                        class="hidden md:table w-full divide-y divide-gray-200"
                    >
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr v-for="report in reports.data" :key="report.id">
                                ...
                                <td
                                    class="px-4 py-4 text-sm text-gray-500 max-w-xs"
                                >
                    ...
                    >
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            You haven't submitted any reports yet. Click "Add
