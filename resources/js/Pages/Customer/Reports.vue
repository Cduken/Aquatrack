<template>
    <CustomerLayout title="Customer Reports">
        <div class="w-full bg-white shadow-xl rounded-xl overflow-hidden border border-gray-100">
                ...
                <div class="bg-white p-5 rounded-xl border border-gray-200 shadow-sm">
                    <div class="flex items-center">
                        <div class="p-3 bg-blue-100 rounded-xl mr-4">
                            <v-icon name="bi-file-earmark-text" class="text-blue-600 w-6 h-6" />
                        </div>
                ...
                <div class="bg-white p-5 rounded-xl border border-gray-200 shadow-sm">
                    <div class="flex items-center">
                        <div class="p-3 bg-amber-100 rounded-xl mr-4">
                            <v-icon name="bi-clock-history" class="text-amber-600 w-6 h-6" />
                        </div>
                        <div>
                ...
                <div class="bg-white p-5 rounded-xl border border-gray-200 shadow-sm">
                    <div class="flex items-center">
                        <div class="p-3 bg-purple-100 rounded-xl mr-4">
                            <v-icon name="bi-arrow-repeat" class="text-purple-600 w-6 h-6" />
                        </div>
                        <div>
                            <p class="text-sm font-medium text-gray-600">In Progress</p>
                            <p class="text-2xl font-bold text-gray-900">
                                {{ reports.data.filter(r => r.status === 'in_progress').length }}
                            </p>
                        </div>
                    </div>
                </div>
                <div class="bg-white p-5 rounded-xl border border-gray-200 shadow-sm">
                    <div class="flex items-center">
                        <div class="p-3 bg-green-100 rounded-xl mr-4">
                            <v-icon name="bi-check-circle" class="text-green-600 w-6 h-6" />
                        </div>
                        <div>
            ...
            <div class="p-6">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6 p-4 bg-gray-50 rounded-xl">
                    <div class="flex-1">
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <v-icon name="bi-search" class="text-gray-400 w-5 h-5" />
                            </div>
                            <input
                                type="text"
                    ...
                    <div class="flex items-center gap-3">
                        <select class="border border-gray-300 rounded-lg px-3 py-2.5 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            <option>All Status</option>
                            <option>Pending</option>
                            <option>In Progress</option>
                            <option>Resolved</option>
                        </select>
                        <button class="p-2.5 border border-gray-300 rounded-lg hover:bg-gray-100 transition-colors">
                            <v-icon name="bi-filter" class="text-gray-600 w-5 h-5" />
                        </button>
                    </div>
                </div>
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                >
                                    ...
                                    <td class="px-6 py-5 whitespace-nowrap text-sm text-gray-700">
                                        <div class="flex items-center">
                                            <v-icon name="bi-geo-alt" class="text-gray-400 mr-2 w-4 h-4" />
                                    ...
                                    <td class="px-6 py-5 whitespace-nowrap">
                                        <span :class="statusClasses(report.status)" class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium">
                                            <span class="w-2 h-2 rounded-full mr-2" :class="{
                                                'bg-gray-500': report.status === 'pending',
                                                'bg-blue-500': report.status === 'in_progress',
                                ...
                                <tr v-if="reports.data.length === 0">
                                    <td colspan="7" class="px-6 py-12 text-center">
                                        ...
                                        <p class="text-gray-500 mb-6 max-w-md mx-auto">
                                            You haven't submitted any water quality reports yet. Click "Submit New Report" to get started.
                                        </p>
                                    </td>
                                </tr>
                            </tbody>
                    ...
                    >
                        ...
                        >
                            ...
                            <div>
                                ...
                                >
                                    <Link
                                        v-for="(link, index) in reports.meta.links"
                                        :key="index"
                                        :href="link.url"
                                        :disabled="!link.url"
                                        :class="[
                                            ...
                                            index === reports.meta.links.length - 1
                                                ? 'rounded-r-md' : '',
                                        ]"
                                        v-html="link.label"
                                    />
