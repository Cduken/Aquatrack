                    ...
                    <table class="w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Content
                                </th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr v-for="report in reports" :key="report.id">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ report.content
                                    }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ report.date }}
                                </td>
...
const reports = ref([
    {
        ...
        content: 'We are conducting maintenance on the water supply system.',
        last_reading: '120 m3',
        consumption: '15 m3',
        amount_due: '120.50',
        date: '2023-05-01',
    ...
    },
    {
        ...
        content: 'We are implementing a new billing system next month.',
        last_reading: '85 m3',
        consumption: '10 m3',
        amount_due: '95.75',
        date: '2023-05-03',
    ...
    },
    {
        ...
        content: 'We are implementing new water conservation measures.',
        consumption: '25 m3',
        amount_due: '150.20',
        date: '2023-05-05',
        status: 'Active',
