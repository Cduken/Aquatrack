        ...
        <div class="px-4 sm:px-0">
            <div class="flex flex-col space-y-6">
                ...
                <div class="bg-white shadow-lg rounded-xl overflow-hidden border border-gray-100">
                    <div class="p-6">
                        <div class="flex items-center space-x-3 mb-4">
                            <v-icon name="bi-person-fill" class="text-blue-500 text-xl" />
                            <h3 class="text-xl font-semibold text-gray-800">Profile Information</h3>
                        </div>
                        <p class="mt-1 text-sm text-gray-600 mb-6">Update your account's profile information and email
                            address.</p>

                        <!-- Avatar Upload -->
                        <div class="flex items-center space-x-6 mb-6">
                            <div class="shrink-0">
                                <img v-if="avatarPreview" class="h-20 w-20 rounded-full object-cover"
                                    :src="avatarPreview" alt="Current avatar" />
                                <div v-else class="h-20 w-20 rounded-full bg-gray-200 flex items-center justify-center">
                                    <v-icon name="bi-person-fill" class="text-gray-400 text-3xl" />
                                </div>
                            </div>
                            <label class="block">
                                <span class="sr-only">Choose profile photo</span>
                                <input @change="handleAvatarChange" ref="avatarInput" type="file" accept="image/*"
                        ...
                        <div class="space-y-6">
                            <div>
                                <div class="flex items-center space-x-2 mb-2">
                                    <v-icon name="bi-person-fill" class="text-gray-500" />
                                    <label for="name" class="block text-sm font-medium text-gray-700">Name</label>
                                </div>
                                <input v-model="profileForm.name" id="name" type="text" autocomplete="name" required
                            ...
                            <div>
                                <div class="flex items-center space-x-2 mb-2">
                                    <v-icon name="bi-envelope-fill" class="text-gray-500" />
                                    <label for="email" class="block text-sm font-medium text-gray-700">Email</label>
                                </div>
                                <input v-model="profileForm.email" id="email" type="email" autocomplete="email" required
                                    class="block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-150" />
                            ...
                            <div class="pt-4">
                                <button @click="updateProfile" :disabled="profileForm.processing"
                                    ...
                                    <v-icon name="bi-check-circle-fill" class="mr-2" />
                                    Save Profile
                                </button>
                            </div>
                        </div>
                ...
                <div class="bg-white shadow-lg rounded-xl overflow-hidden border border-gray-100">
                    <div class="p-6">
                        <div class="flex items-center space-x-3 mb-4">
                            <v-icon name="bi-lock-fill" class="text-green-500 text-xl" />
                        ...
                        <div class="space-y-6">
                            <div>
                                <div class="flex items-center space-x-2 mb-2">
                                    <v-icon name="bi-key-fill" class="text-gray-500" />
                            ...
                            <div>
                                <div class="flex items-center space-x-2 mb-2">
                                    <v-icon name="bi-shield-lock-fill" class="text-gray-500" />
                                    <label for="password" class="block text-sm font-medium text-gray-700">New
                                        Password</label>
                                </div>
                                <input v-model="passwordForm.password" id="password" type="password"
                            ...
                            <div>
                                <div class="flex items-center space-x-2 mb-2">
                                    <v-icon name="bi-shield-fill-check" class="text-gray-500" />
                                    <label for="password_confirmation"
                                        class="block text-sm font-medium text-gray-700">Confirm Password</label>
                                </div>
                                <input v-model="passwordForm.password_confirmation" id="password_confirmation"
                            ...
                            <div class="pt-4">
                                <button @click="updatePassword" :disabled="passwordForm.processing"
                                    ...
                                    <v-icon name="bi-arrow-repeat" class="mr-2" />
                                    Update Password
                                </button>
                            </div>
                        </div>
