                        ...
                        <div class="flex-1 overflow-y-auto p-6">
                            ...
                            >
                                        ...
                                        <div class="flex items-start">
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <input
                                                    ...
                                                    readonly
                                                    value="Clarin"
                                                    class="w-full p-3 rounded-lg text-gray-900 bg-gray-50 border border-gray-200 placeholder:text-gray-400 cursor-not-allowed text-sm shadow-inner"
                                                />
                                            </div>
                                        </div>
                                        <div class="flex items-start">
                                ...
                                >
                                    ...
                                    <div
                                        class="bg-white p-4 rounded-xl border border-gray-200 shadow-inner mt-4"
                                    >
                                        <textarea
                                            id="description"
