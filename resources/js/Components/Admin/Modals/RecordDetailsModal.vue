                        ...
                        >
                            <div class="space-y-6">
                                ...
                                >
                                    ...
                                    >
                                        <div
                                            class="flex items-start p-3 rounded-lg bg-gray-50 dark:bg-gray-600/30"
                                        >
                                            <v-icon
                                                name="bi-person-badge"
                                                class="mr-3 mt-0.5 text-blue-500"
                                            />
                                            <div>
                                                <p
                                        ...
                                        >
                                            ...
                                            <div>
                                                ...
                                                >
                                                    ...
                                                    <span
                                                        v-if="isOverdue"
                                                        class="text-xs ml-2 px-2 py-1 bg-red-100 text-red-800 rounded-full"
                                                        >Overdue</span
                                                    >
                                                </p>
                                            </div>
